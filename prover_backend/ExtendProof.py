...
#
# def ReorderResolutionChain_(goal, chain, resolution_list):
#     clausechain = []
#     res = []
#     for index in chain:
#         clausechain.append(resolution_list[index].clause.copy())
#     sortedclausechain = sort(goal, clausechain, clausechain)
#     print("finish ~~")
#     map = get_map(sortedclausechain, clausechain)
#     orderedchain = reorder(map, chain)
#     for i in range(len(orderedchain)):
#         res.append(orderedchain[len(orderedchain) - i-1])
#     return  res
...
# resolution_single = unfold(resolution_raw)
